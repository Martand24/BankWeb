...
//     avatar: "https://i.pravatar.cc/40?img=12", // Replace with real user photo or avatar
//   };
...
//   return (
//     <nav className="bg-white dark:bg-gray-900 shadow-md px-4 py-3 flex items-center justify-between relative">
//       <div className="text-xl font-bold text-indigo-600 dark:text-white">
//         <Link to="/">BankSecure Admin</Link>
//       </div>
